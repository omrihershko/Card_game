...
bool Ghost::fight_aginst_figther(Characters *characters,Set_card &my_set) {
...
bool Ghost::fight_aginst_bow_man(Characters *characters,Set_card &my_set) {
    ...
    new_live=max(new_live- this->point_damage,0);
    characters->set_live_point(new_live);
...
bool Ghost::fight_aginst_wizard(Characters *characters,Set_card &my_set) {
    int damageDealt = my_set.get_atack();
