...
bool Dragon::fight_aginst_wizard(Characters *characters,Set_card &my_set) {
...
bool Dragon::fight_aginst_bow_man(Characters *characters,Set_card &my_set) {
...
bool Dragon::fight_aginst_figther(Characters *characters,Set_card &my_set) {
    int damageDealt = my_set.get_atack();
